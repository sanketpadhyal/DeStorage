...
const GithubIcon: React.FC<GithubIconProps> = ({ size = 16 }) => (
...
type TabType = 'vault' | 'upload' | 'favorites' | 'sharing';

export const LandingPage: React.FC<LandingPageProps> = ({ onLaunchApp }) => {
  const [activeTab, setActiveTab] = useState<TabType>('vault');
  
  // Interactive Web Crypto Live Demo State
  const [demoInput, setDemoInput] = useState<string>('My top secret financial report & family photos.');
